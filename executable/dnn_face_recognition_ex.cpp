...
{
    /**
     * step1: set shape_predictor_5_face_landmarks
     * step2: set dlib_face_recognition_resnet_model_v1s
     * step3: set imgdir
     */

    char* shape_predictor_5_face_landmarks_file = "../../res/models/shape_predictor_5_face_landmarks.dat";
    char* dlib_face_recognition_resnet_model_v1s = "../../res/models/dlib_face_recognition_resnet_model_v1.dat";
    char* imgdir = "../../data/facedetection/2008_001009.jpg";
//    if (argc != 2)
//    {
...
//    }
    ...
    shape_predictor sp;
    deserialize(shape_predictor_5_face_landmarks_file) >> sp;
    // And finally we load the DNN responsible for face recognition.
    anet_type net;
    deserialize(dlib_face_recognition_resnet_model_v1s) >> net;

    matrix<rgb_pixel> img;
    load_image(img, imgdir);
